package classes.manage.rollManage
{
	 ...
	 * @author Ethan
	 */
	public class RollStopWithAlphaBgManage implements IStopRoll
	{
		...
		private var _mask1:MovieClip;
		private var _mask2:MovieClip;
		private var _mask3:MovieClip;
		private var _mask4:MovieClip;
		private var _mask5:MovieClip;
		private var _masks:Vector.<MovieClip>;
		
		public function RollStopWithAlphaBgManage(stopWin:MovieClip, startManage:IRoll, overFunc:Function,mask1:MovieClip,mask2:MovieClip,mask3:MovieClip,mask4:MovieClip,mask5:MovieClip)
		{
			...
			_masks =  new Vector.<MovieClip>;
			_mask1 = mask1;
			_mask2 = mask2;
			_mask3 = mask3;
			_mask4 = mask4;
			_mask5 = mask5;
			_masks.push(_mask1, _mask2, _mask3, _mask4, _mask5);
		...
		public function manuallyStop():void // 五列一起停止
		{
			...
			for (var i:uint = 0; i < _sCs.length; i++)
			{
				...
				{
					TweenLite.to(_sCs[i], STOP_TIME - 0.09, { y: 7, alpha: 1, delay: Math.random() * 0.1 + 0.1,onUpdate:moveMask,onUpdateParams:[_sCs[i],i] , onComplete: backFun, onCompleteParams: [_sCs[i]] } );
					function moveMask(value:MovieClip,num:uint) {
						_masks[num].height = value.y - 7;
					}
				}
		...
		public function autoStop():void // 一列一列停止
		{
			...
			_sound.stopRollSound.play();
			TweenLite.to(_sCs[0], STOP_TIME, {y: _time, alpha: 1,onUpdate:moveMask1,onUpdateParams:[_sCs[0]] , onComplete: backFun_1, onCompleteParams: [_sCs[0]]});
			function moveMask1(value:MovieClip) :void{
				_masks[0].height = value.y - _time;
			}
			...
			function go_2():void
			{
				TweenLite.to(_sCs[1], STOP_TIME, {y: _time, alpha: 1,onUpdate:moveMask2,onUpdateParams:[_sCs[1]] , onComplete: backFun_2, onCompleteParams: [_sCs[1]]});
			}
			function moveMask2(value:MovieClip) :void{
				_masks[1].height =value.y - _time;
			}
			...
			function go_3():void
			{
				TweenLite.to(_sCs[2], STOP_TIME, {y: _time, alpha: 1,onUpdate:moveMask3,onUpdateParams:[_sCs[2]] , onComplete: backFun_3, onCompleteParams: [_sCs[2]]});
			}
			function moveMask3(value:MovieClip) :void{
				_masks[2].height = value.y - _time;
			}
			...
			function go_4():void
			{
				TweenLite.to(_sCs[3], STOP_TIME, {y: _time, alpha: 1,onUpdate:moveMask4,onUpdateParams:[_sCs[3]] , onComplete: backFun_4, onCompleteParams: [_sCs[3]]});
			}
			function moveMask4(value:MovieClip) :void{
				_masks[3].height = value.y - _time;
			}
			...
			function go_5():void
			{
				TweenLite.to(_sCs[4], STOP_TIME, {y: _time, alpha: 1,onUpdate:moveMask5,onUpdateParams:[_sCs[4]] , onComplete: backFun_5, onCompleteParams: [_sCs[4]]});
			}
			function moveMask5(value:MovieClip) :void{
				_masks[4].height = value.y - _time;
			}
